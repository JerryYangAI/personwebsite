...
export const translations = {
  zh: {
    ...
    services: {
      sectionLabel: 'Services · 合作方式',
      title: '合作方式',
      subtitle: '为企业、高校与团队提供 AI 领域的专业服务。',
      priceLabel: '报价',
      pricingLabel: 'Pricing · 报价',
      viewDetails: '查看详细介绍',
      backToHub: '返回合作方式总览',
      pastClientsLabel: 'Past Clients · 合作过的机构',
      pastClientsFooter: '更多过往合作正在补充中。',
      getInTouchLabel: 'Get in Touch · 开始合作',
      getInTouchTitle: '一起做点真东西',
      getInTouchSub: '不论演讲、培训，还是项目共创，欢迎直接邮件或微信联系。',
      copyButton: '复制',
      copied: '已复制',
      ...
      speaking: {
        title: '演讲与培训',
        titleEn: 'Speaking & Training',
        summary: '面向高校与企业团队的 AI 实战分享与定制培训。从 AI 投资到原生创业，从多模态到 Claude Code 工作流，按你们的场景定制。',
        heroTitle: '演讲与培训',
        heroSub: '— 一位在硅谷一线 + 斯坦福实验室的 AI 从业者，用人话讲清楚 AI 正在发生什么。',
        stat1Num: '3 万+',
        stat1Label: '公众号关注',
        stat2Num: '5 万+',
        stat2Label: '视频号粉丝',
        ...
        ctaBook: '发邮件邀请',
        ctaPdf: '下载介绍 PDF',
        responseSla: '* 通常 24-48 小时内回复',
        topicsHeading: 'Topics on Request',
        topicsTitle: '可定制的主题',
        topicsFooter: '* 以上为常见主题，所有内容均可按你们的行业 / 场景 / 人群重新定制。',
        topic1Title: 'AI 投资视角 · 黄仁勋的 5 层蛋糕 + 纳瓦尔的工业革命',
        topic1Desc: '从能源到芯片到应用层 — 投资人如何在这一轮看清楚机会与风险。',
        topic2Title: 'AI 原生创业 · Idea → MVP → Launch → Scale',
        topic2Desc: '一份从硅谷一线总结的 AI 原生创业方法论，给创始人和早期团队用。',
        topic3Title: '多模态、世界模型与具身智能',
        topic3Desc: '后 Transformer 时代的技术路线 — Marble 与 Stanford 的最新进展、产品边界与落地节奏。',
        topic4Title: 'Claude Code · CLAUDE.md · 上下文工程实战',
        topic4Desc: 'Anthropic 团队的内部方法论 — 如何让一位工程师交付 10× 产出，给技术 leader 与团队。',
        topic5Title: 'AI 时代的个人品牌与创作者经济',
        topic5Desc: '从公众号到视频号到 jerryyang.ai — 一份非典型的内容杠杆方法论。',
        topic6Title: 'AI 时代的高管必修 · 把团队变成 "人 + Agent"',
        topic6Desc: '面向企业高管的工作坊：识别高杠杆任务，重写工作流，避免转型失败的几种典型路径。',
        price: '5–8 万',
        priceUnit: '/ 场',
        priceNote: '* 价格视主题、深度、时长与现场 / 远程而定。多场打包、长期合作可议。',
      },
      business: {
        title: '企业商业合作',
        titleEn: 'Business Cooperation',
        summary: 'AI 项目共创 · 技术 / 战略顾问 · 内容合作 · 品牌共创。基于硅谷一线 + 斯坦福研究背景，帮你把 AI 战略真正落到产品和团队里。',
        heroTitle: '企业商业合作',
        heroSub: '— 把 AI 战略，落到你们真正会发版的产品里。',
        positioning: 'Dario Amodei 把 AI 的真正承诺写成 "machines of loving grace" — 让 AI 把更多人，带到一个曾经被技术门槛挡在门外的新世界。我想做的，是把硅谷一线的认知和工具，交到中文世界更多创业者、团队与机构手里。',
        typesHeading: 'Types of Cooperation',
        typesTitle: '两种合作方式',
        scopeLabel: '场景 · Scope',
        deliversLabel: '交付 · Deliverables',
        type1Title: '演讲与培训',
        type1Scope: '面向高校校友会、企业内训、投资机构闭门会 — 把硅谷一线的 AI 认知与方法论传递给团队。',
        type1Delivers: '定制主题 · 现场 / 远程交付 · 多场打包与长期合作可议。',
        type2Title: 'AI 技术与战略顾问',
        type2Scope: 'AI 产品 0 到 1 · 模型与架构选型 · 团队 AI 转型陪跑 · 上市公司 AI 战略 — 把战略落到产品和团队里。',
        type2Delivers: '战略与架构文档 · 月度 / 季度闭门陪跑 · 关键时刻可用电话 · 招聘与团队设计建议。',
        type3Title: '内容合作 / 品牌共创',
        type3Scope: '公众号 / 视频号 / LinkedIn 联合发布、专题系列、品牌共创内容。',
        type3Delivers: '深度内容 · 跨平台分发 · 投后讨论与数据回顾。',
        type4Title: '产品推广 / KOL 投放',
        type4Scope: 'AI 工具 / 硬件 / 教育产品的精准触达 — 面向创业者、技术决策者、AI 爱好者群体。',
        type4Delivers: '深度评测稿 · 视频内容 · 投放方案与转化报告。',
        reachHeading: '跨平台触达 · Cross-Platform Reach',
        reach1Label: '公众号关注',
        reach2Label: '视频号粉丝',
        reach3Label: 'AI 实验室在读',
        reach4Label: '硅谷 + 中国双现场',
        pastCasesLabel: 'Past Cases · 过往项目',
        price: '定价可议',
        priceNote: '* 视项目类型、深度、周期与团队规模而定。年度框架协议可享有显著折扣。',
        ctaQuote: '发送报价邀请',
      },
    },
  },
  en: {
    ...
    services: {
      sectionLabel: 'Services · Cooperation',
      title: 'How We Can Work Together',
      subtitle: 'Professional AI services for enterprises, universities, and teams.',
      priceLabel: 'Pricing',
      pricingLabel: 'Pricing',
      viewDetails: 'See full details',
      backToHub: 'Back to all services',
      pastClientsLabel: 'Past Clients',
      pastClientsFooter: 'More past collaborations to be added.',
      getInTouchLabel: 'Get in Touch',
      getInTouchTitle: "Let's build something real",
      getInTouchSub: 'For speaking, training, or project collaboration — email or WeChat works best.',
      copyButton: 'Copy',
      copied: 'Copied',
      wechatLabel: 'WeChat',
      webSub: 'Personal site',
      comingSoon: 'Coming soon',
      speaking: {
        title: 'Speaking & Training',
        titleEn: '演讲与培训',
        summary: 'Talks and custom training for universities and corporate teams — AI investing, AI-native entrepreneurship, world models, Claude Code workflows.',
        heroTitle: 'Speaking & Training',
        heroSub: '— A working AI practitioner from Silicon Valley + Stanford, explaining AI in plain language.',
        stat1Num: '30K+',
        stat1Label: 'WeChat followers',
        stat2Num: '50K+',
        stat2Label: 'Video Channel followers',
        stat3Num: '20+',
        stat3Label: 'Talks delivered',
        stat4Num: '10+',
        stat4Label: 'Institutions served',
        ctaBook: 'Request booking',
        ctaPdf: 'Download brochure',
        responseSla: '* Usually responds within 24-48h',
        topicsHeading: 'Topics on Request',
        topicsTitle: 'Topics tailored to your audience',
        topicsFooter: '* These are typical topics; everything can be re-customized.',
        topic1Title: "AI investing: Jensen's 5-layer cake + Naval's industrial revolution",
        topic1Desc: 'From energy to chips to the application layer — how investors should read this cycle.',
        topic2Title: 'AI-native startups: Idea → MVP → Launch → Scale',
        topic2Desc: 'A practitioner methodology for AI-native company building.',
        topic3Title: 'Multimodal, world models, embodied AI',
        topic3Desc: 'Beyond Transformer — Marble, Stanford research, deployment cadence.',
        topic4Title: 'Claude Code, CLAUDE.md, and context engineering',
        topic4Desc: "Anthropic's internal methodology — 10x output from one engineer.",
        topic5Title: 'Personal brand & creator economy in the AI era',
        topic5Desc: 'An atypical content-leverage playbook.',
        topic6Title: 'Executive workshop · humans + agents',
        topic6Desc: 'Identifying high-leverage tasks, rewriting workflows.',
        price: '¥50–80K',
        priceUnit: '/ session',
        priceNote: '* Final pricing depends on topic, depth, duration. Bundles negotiable.',
      },
      business: {
        title: 'Business Cooperation',
        titleEn: '企业商业合作',
        summary: 'AI co-creation, technical/strategic advising, content partnerships, brand collaboration.',
        heroTitle: 'Business Cooperation',
        heroSub: '— Translate AI strategy into product your team actually ships.',
        positioning: 'Dario Amodei called the real promise of AI "machines of loving grace" — using AI to bring more people into a world once gated by technical barriers. What I want to do is hand the first-hand insights and tools from Silicon Valley to more founders, teams, and institutions in the Chinese-speaking world.',
        typesHeading: 'Types of Cooperation',
        typesTitle: 'Two ways we can work',
        scopeLabel: 'Scope',
        deliversLabel: 'Deliverables',
        type1Title: 'Speaking & Training',
        type1Scope: 'For alumni events, corporate training, and investor closed-door sessions — bringing first-hand Silicon Valley AI insights and methodology to your team.',
        type1Delivers: 'Custom topics · on-site / remote · bundle and long-term deals negotiable.',
        type2Title: 'AI Tech & Strategy Advising',
        type2Scope: 'AI product 0-to-1 · model & architecture decisions · team AI transformation · public-company AI strategy — translating strategy into product and team.',
        type2Delivers: 'Strategy & architecture docs · monthly closed-door advising · phone access in critical moments · hiring & team design guidance.',
        type3Title: 'Content partnership / brand co-creation',
        type3Scope: 'Joint releases, deep-dive series, brand collaboration.',
        type3Delivers: 'Deep content, cross-platform distribution, data review.',
        type4Title: 'Product promotion / KOL placement',
        type4Scope: 'Precision reach for AI tools, hardware, education products.',
        type4Delivers: 'Deep review, video content, placement plan and report.',
        reachHeading: 'Cross-Platform Reach',
        reach1Label: 'WeChat followers',
        reach2Label: 'Video Channel followers',
        reach3Label: 'AI lab researcher',
        reach4Label: 'Silicon Valley + China',
        pastCasesLabel: 'Past Cases',
        price: 'On Request',
        priceNote: '* Depends on project type, depth, duration, team size.',
  ...
  ja: {
    ...
    services: {
      sectionLabel: 'Services · 協業',
      title: '協業のかたち',
      subtitle: '企業・大学・チームに向けた AI 領域の専門サービス。',
      priceLabel: '料金',
      pricingLabel: 'Pricing · 料金',
      viewDetails: '詳細を見る',
      backToHub: 'サービス一覧に戻る',
      pastClientsLabel: 'Past Clients · 取引先',
      pastClientsFooter: '過去の協業事例を順次追加中。',
      getInTouchLabel: 'Get in Touch · お問い合わせ',
      getInTouchTitle: '一緒に「本物」を作りましょう',
      getInTouchSub: '講演・研修・プロジェクト協業 — メールまたは WeChat でお気軽にどうぞ。',
      copyButton: 'コピー',
      copied: 'コピー済み',
      wechatLabel: 'WeChat',
      webSub: '個人サイト',
      ...
      speaking: {
        title: '講演と研修',
        titleEn: 'Speaking & Training',
        summary: '大学・企業向けの AI 実践共有とカスタム研修。',
        heroTitle: '講演と研修',
        heroSub: '— シリコンバレー一線とスタンフォードの AI 実務家が、平易な言葉で AI の現在を解説します。',
        stat1Num: '3万+',
        stat1Label: 'WeChat フォロワー',
        stat2Num: '5万+',
        stat2Label: 'ビデオチャンネル登録',
        stat3Num: '20+',
        stat3Label: '登壇回数',
        stat4Num: '10+',
        stat4Label: '取引機関',
        ctaBook: 'お問い合わせ',
        ctaPdf: '紹介資料 PDF',
        responseSla: '* 通常 24-48 時間以内に返信',
        topicsHeading: 'Topics on Request',
        topicsTitle: 'カスタマイズ可能なトピック',
        topicsFooter: '* 上記は代表例です。',
        topic1Title: 'AI 投資：5 層ケーキ + ナバール「産業革命」',
        topic1Desc: 'エネルギーからチップ、アプリ層まで。',
        topic2Title: 'AI ネイティブ起業：Idea → MVP → Launch → Scale',
        topic2Desc: 'シリコンバレーで実践してきた AI ネイティブ企業作りの方法論。',
        topic3Title: 'マルチモーダル・ワールドモデル・エンボディド AI',
        topic3Desc: 'Transformer の先 — Marble、Stanford 研究、実装のタイミング。',
        topic4Title: 'Claude Code · CLAUDE.md · コンテキストエンジニアリング',
        topic4Desc: 'Anthropic の内部方法論 — エンジニア 1 人で 10× 成果を出す方法。',
        topic5Title: 'AI 時代の個人ブランドとクリエイターエコノミー',
        topic5Desc: '非典型なコンテンツレバレッジの作り方。',
        topic6Title: 'エグゼクティブ研修：チームを「人 + Agent」に',
        topic6Desc: '経営層向けワークショップ。',
        price: '5–8 万',
        priceUnit: '/ 回',
        priceNote: '* 応相談。',
      },
      business: {
        title: '企業協業',
        titleEn: '企业商业合作',
        summary: 'AI プロダクト共創・技術 / 戦略顧問・コンテンツ協業・ブランド共創。',
        heroTitle: '企業協業',
        heroSub: '— AI 戦略を、実際にリリースされるプロダクトに落とし込みます。',
        positioning: 'Dario Amodei は AI の本当の約束を 「machines of loving grace」 と呼びました — AI で、これまで技術の壁に阻まれていた多くの人を、新しい世界へ連れていく。私がやりたいのは、シリコンバレー一線の知見とツールを、中国語圏のより多くの創業者・チーム・機関に届けることです。',
        typesHeading: 'Types of Cooperation',
        typesTitle: '2 つの協業タイプ',
        scopeLabel: 'Scope · 範囲',
        deliversLabel: 'Deliverables · 成果物',
        type1Title: '講演と研修',
        type1Scope: '同窓会・企業内研修・投資家クローズドセッション向け — シリコンバレー一線の AI 知見と方法論をチームに。',
        type1Delivers: 'カスタムテーマ · 対面 / リモート · 複数回 / 長期契約は応相談。',
        type2Title: 'AI 技術 / 戦略顧問',
        type2Scope: 'AI プロダクト 0-1 · モデル / アーキ判断 · チーム AI 転換伴走 · 上場企業 AI 戦略 — 戦略をプロダクトとチームに実装。',
        type2Delivers: '戦略 / アーキドキュメント · 月次 / 四半期クローズド伴走 · 重要局面の電話アクセス · 採用 / 組織設計の助言。',
        type3Title: 'コンテンツ協業・ブランド共創',
        type3Scope: '共同発表、深掘りシリーズ、ブランド共創。',
        type3Delivers: 'ディープコンテンツ・クロスプラットフォーム配信。',
        type4Title: 'プロダクト宣伝 / KOL 配信',
        type4Scope: 'AI ツール・ハードウェア・教育プロダクトの精密リーチ。',
        type4Delivers: 'ディープレビュー・ビデオコンテンツ。',
        reachHeading: 'クロスプラットフォーム到達',
        reach1Label: 'WeChat フォロワー',
        reach2Label: 'ビデオチャンネル登録',
        reach3Label: 'AI ラボ研究員',
        reach4Label: 'SV + 中国 両拠点',
        pastCasesLabel: 'Past Cases · 過去の案件',
        price: '応相談',
        priceNote: '* プロジェクトタイプ・深度・期間・チーム規模で変動。',
        ctaQuote: '見積依頼',
      },
    },
  }
