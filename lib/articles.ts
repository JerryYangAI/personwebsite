...
export const articles: Article[] = [
  {
    ...
    category: 'ai',
    date: '2026-06-12',
    tag: 'ARXIV 2604 · MBZUAI · 2026/04',
    title: {
      zh: '深入 Claude Code：AI 智能体的设计空间',
      en: 'Dive into Claude Code: The Design Space of AI Agent Systems',
      ja: 'Claude Code の解剖：AI エージェントの設計空間',
    },
    subtitle: {
      zh: 'MBZUAI VILA Lab · 中文精校版',
      en: 'MBZUAI VILA Lab · Curated Chinese Edition',
      ja: 'MBZUAI VILA Lab · 中国語精製版',
    },
    desc: {
      zh: 'MBZUAI VILA Lab 对 Claude Code TypeScript 源码做的逆向架构分析中文精校版。从 5 个人类价值观到 13 个设计原则，从 while-true 循环到 5 层压缩管道——把 Anthropic 这款最重要的 agentic coding 工具的内部结构完整拆解。核心发现：只有 1.6% 是 AI 决策逻辑，98.4% 是运营基础设施。',
      en: "MBZUAI VILA Lab's source-level architectural analysis of Claude Code. From 5 human values to 13 design principles, from while-true loop to 5-layer compaction pipeline. Core finding: only 1.6% is AI decision logic, 98.4% is operational infrastructure.",
      ja: 'MBZUAI VILA Lab による Claude Code ソースコード分析。5 つの人間価値観から 13 の設計原則まで、while ループから 5 層圧縮パイプラインまで。1.6% が AI 判断ロジック、98.4% が運用基盤。',
    },
    meta: {
      zh: ['10 章', '约 40 分钟', '源码级分析'],
      en: ['10 chapters', '~40 min read', 'Source-level analysis'],
      ja: ['10 章', '約 40 分', 'ソース解析'],
    },
    theme: 'blue',
    featured: true,
  },
