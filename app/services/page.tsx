...
/**
 * /services — Hub page
 * Overview of both services with links to detail pages.
 */
            ...
            {cards.map((card, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-[#e8e6dc]/50 relative overflow-hidden flex flex-col p-8 md:p-10"
                >
                  ...
                  <p className="font-serif italic text-[#141413]/50 text-base mb-6">
                    {card.titleEn}
                  </p>

                  <p className="text-[#141413]/80 leading-relaxed mb-8">{card.summary}</p>
                  ...
                  <div className="flex items-end justify-between mt-4">
                    ...
                    <Link
                      href={card.href}
                      className="inline-flex items-center gap-2 text-sm text-[#141413] border-b border-[#141413]/40 hover:border-[#141413] pb-0.5 transition-colors"
                    >
                      <span>{card.cta}</span>
